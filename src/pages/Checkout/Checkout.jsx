  ...
  return (
    <div className={styles.wrap}>
      ...
      <div className={styles.layout}>
            ...
            >
              <label className={styles.radioOption}>
                ...
                <span className={styles.radioText}>
                  ...
                  <span className={styles.radioHint}>
                    Готово через 3–5 робочих днів, безкоштовно.
                  </span>
                </span>
              </label>
              ...
              <label className={styles.radioOption}>
                ...
                <span className={styles.radioText}>
                  ...
                  <span className={styles.radioHint}>
                    Нова пошта або кур’єр. Деталі в коментарі.
                  </span>
                </span>
              </label>
            </div>
        ...
        <aside
          className={`${styles.summary} ${styles.summaryMobile}`}
        >
